...
![Soal WKNN Normalisasi (Lampiran Tambahan)](Tugas/WKNN_Normalisasi/Soal_Missing_Values.png)

Lampiran file Excel (siap diunduh/dibagikan):

[Download Excel - Missing Value Metode WKKN dan Normalisasi](Tugas/WKNN_Normalisasi/Metode_WKKN_dan_Normalisasi.xlsx)

Preview sheet perhitungan manual (sesuai file Excel):

![Sheet WKNN dan 3 normalisasi](Tugas/WKNN_Normalisasi/sheet_WKNN_dan_3_normalisasi.png)

![Sheet parameter kontrol WKNN](Tugas/WKNN_Normalisasi/sheet_parameter_kontrol_WKNN.png)

![Sheet normalisasi Min-Max](Tugas/WKNN_Normalisasi/sheet_normalisasi_Min-Max.png)

![Sheet tabel tetangga terdekat WKNN](Tugas/WKNN_Normalisasi/sheet_tabel_tetangga_terdekat_WKNN.png)
...
>
> ![Rumus Min-Max Normalization — Persamaan (3.9) dari buku Data Preprocessing in Data Mining](Tugas/WKNN_Normalisasi/gambar_buku/rumus_minmax_3.9.png)
>
...
>
> ![Rumus Z-Score Normalization — Persamaan (3.10) dari buku Data Preprocessing in Data Mining](Tugas/WKNN_Normalisasi/gambar_buku/rumus_zscore_3.10.png)
>
...
>
> ![Rumus Standar Deviasi, Mean Absolute Deviation, dan Decimal Scaling — Persamaan (3.12)–(3.15) dari buku Data Preprocessing in Data Mining](Tugas/WKNN_Normalisasi/gambar_buku/rumus_stddev_decimal_scaling_3.12-3.15.png)
>
